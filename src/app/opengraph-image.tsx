...
export default async function Image() {
  ...
  const moviesRaw = await readFile(
  ...
  const [antonData, manropeBoldData] = await Promise.all([
    readFile(path.join(fontBasePath, "Anton-Regular.ttf")),
    readFile(path.join(fontBasePath, "Manrope-Bold.ttf")),
  ]);
          ...
          >
            <div
              style={{
                ...
                overflow: "hidden",
                boxShadow:
                  "0 20px 40px rgba(0,0,0,0.5), 0 0 60px rgba(56, 189, 248, 0.15)",
              }}
            >
